...
class GeneralReportExport implements FromArray, WithHeadings, WithCustomStartCell, ShouldAutoSize, WithStyles, WithColumnWidths, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {              
                ...
                $sheet->setCellValue("E1", 'Үйлчилгээний захиалгын дэлгэрэнгүй тайлан');
    ...
    public function headings(): array
    {
        ...
        if($this->has_service_type)
            return [' № ', 'Үйлчлүүлэгч', 'Төлөв', 'Огноо', 'Ажилтан', 'Хугацаа', 'Үйлчилгээ', 'Үйлчилгээний код', 'Нэгж төлбөр', 'Төлбөр', 'Хөнгөлөлт', 'Нийт төлсөн - Үүнээс: ', ...$method_names, 'Үлдэгдэл'];
        else
            return [' № ', 'Үйлчлүүлэгч', 'Төлөв', 'Огноо', 'Ажилтан', 'Хугацаа', 'Үйлчилгээ', 'Нэгж төлбөр', 'Төлбөр', 'Хөнгөлөлт', 'Нийт төлсөн - Үүнээс: ', ...$method_names, 'Үлдэгдэл'];
    }
